...
namespace BusinessObjects
{
    ...
    /// </remarks>
    public class StandardizedOffice
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardizedOffice"/> class.
        /// </summary>
        /// <remarks>
        /// Default values are entered into the object at time of instantiation.
        /// </remarks>
        public StandardizedOffice()
        {
            this.cpu.Brand = "Intel";
            this.cpu.Model = "g3258";
            ...
            this.storage.Brand = "Western Digital";
            this.storage.Model = "WD3200AAJS";
            this.storage.Price = 25.00M;
        }
    }
}
